...
//no spaces between property names
var allowedPropertiesForManagedUser =   "userName,password,email,firstName," +
                                        "lastName,userType,status";
//reserve for future use to allow users self change their own properties
//e.g. userSelfUpdatableProperties="email,lastName,firstName";   will allow user to change their own email, firstName and lsatName from openidm stand endpoint
var userSelfUpdatableProperties = "";
...
{ 
    "configs" : [
        ...
        {  
           ...
           "customAuthz" : "nonSelfDeletable() && customManagedUserRestrictedToAllowedProperties('"+allowedPropertiesForManagedUser+"') && disallowQueryExpression()"
        },
        ...
        {  
            ...
            "excludePatterns": "system/*,managed/user/*"
        },
        ...
        // managePassword endpoint
        {
           "pattern"    : "endpoint/managePassword",
           "roles"      : "openidm-reg",
           "methods"    : "*",
           "actions"    : "*"
        },
        ...
        {
            "pattern"   : "endpoint/passwordReset",
            "roles"     : "openidm-admin",
            "methods"   : "*",
            "actions"   : "*"
        },
        ...
        },
        {
            "pattern"   : "managed/user/*",
            "roles"     : "openidm-authorized",
            "methods"   : "read,update,patch,action,query",
            "actions"   : "*",
            "customAuthz" : "ownDataOnly() && managedUserRestrictedToAllowedProperties('"+userSelfUpdatableProperties+"') && disallowQueryExpression()",
        },
        ...
        // Clients authenticated via SSL mutual authentication
        {
            ...
            "actions"   : "patch",
            "customAuthz" : "isQueryOneOf({'managed/user': ['for-userName']}) && managedUserRestrictedToAllowedProperties('ldapPassword')"
        }
    ] 
};
